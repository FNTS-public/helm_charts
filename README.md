[![Helm-Release](https://github.com/FNTS-public/helm_charts/actions/workflows/main.yml/badge.svg)](https://github.com/FNTS-public/helm_charts/actions/workflows/main.yml)
[![pages-build-deployment](https://github.com/FNTS-public/helm_charts/actions/workflows/pages/pages-build-deployment/badge.svg)](https://github.com/FNTS-public/helm_charts/actions/workflows/pages/pages-build-deployment)
## TL;DR

```bash
$ helm repo add fnts https://fnts-public.github.io/helm_charts
$ helm install my-release fnts/my-chart
```
